// Flat C exports observed in UiaManager.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef UIAMANAGER_C_H
#define UIAMANAGER_C_H
...
// Export: UiaInitCrossMachineConnection (ABI unverified)
// Export: UiaInitCrossMachineConnectionW (ABI unverified)

#ifdef __cplusplus
} // extern "C"
#endif
#endif // UIAMANAGER_C_H
