//! Windissect-generated Rust FFI bindings for UiaManager.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "C8156847D18AAABB40FC8B4A358EF14A";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 506732901;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 15] = [85, 105, 97, 77, 97, 110, 97, 103, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 506732901 { return 0; }
